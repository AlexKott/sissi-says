...
const GuideContent = () => ([
  <div key='guide-intro' id='guide-top' className='guide__intro'>
    <h1>Hi, I'm sissi.</h1>
  ...
  <div key='guide-content' className='guide__content'>
    ...
    <h3 id='general-usage'>General Use <a href='#guide-top' className='guide__to-top'>▲</a></h3>
    ...
    <p>The first thing you see when you open the website manager is the index page. Here you can edit the meta data of your website. If you ever want to get back here just find the <code>INDEX</code> button in the top right corner or close the page you are currently on.</p>
    ...
    <h4 id='general-delete'>How to delete pages and sections? <a href='#guide-top' className='guide__to-top'>▲</a></h4>
    ...
    <h4 id='general-reorder'>How to reorder pages and sections? <a href='#guide-top' className='guide__to-top'>▲</a></h4>
    <p>Simple! Just drag and drop them in the nav bar. When you move a page, all its sections will move with it.</p>
    <h3 id='editor'>Editor <a href='#guide-top' className='guide__to-top'>▲</a></h3>
    ...
    <h4 id='editor-headings'>How to add different headings? <a href='#guide-top' className='guide__to-top'>▲</a></h4>
    ...
    <h4 id='editor-italic'>How to make text appear italic? <a href='#guide-top' className='guide__to-top'>▲</a></h4>
    ...
    <h4 id='editor-list'>How to add a list? <a href='#guide-top' className='guide__to-top'>▲</a></h4>
    ...
    <h4 id='editor-image'>How to enter an image? <a href='#guide-top' className='guide__to-top'>▲</a></h4>
